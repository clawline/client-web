      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute right-0 z-40 min-w-[180px] rounded-2xl border border-border/75 bg-white/96 p-1.5 shadow-[0_24px_48px_-26px_rgba(15,23,42,0.38)] backdrop-blur-xl dark:border-border-dark/75 dark:bg-card-alt/96 dark:shadow-[0_24px_48px_-26px_rgba(2,6,23,0.76)]"
            style={{ top: '56px', marginTop: '4px' }}
          >
            <button
