...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="flex items-center gap-1 rounded px-1.5 py-0.5 text-[10px] text-[#a6adc8] transition-colors hover:bg-[#313244] hover:text-[#cdd6f4] active:scale-95"
      title="Copy code"
    >
      {copied ? (
  ...
  return (
    <div className="my-3 overflow-hidden rounded-lg border border-border dark:border-border-dark bg-[#1e1e2e]">
      <div className="flex items-center justify-between border-b border-[#313244] bg-[#181825] px-3 py-1.5">
        <span className="text-[10px] font-medium uppercase text-[#a6adc8]">{lang || 'code'}</span>
