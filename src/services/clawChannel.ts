...
const HEARTBEAT_INTERVAL_MS = 15 * 1000; // 15 seconds — keeps connection alive through proxies
const HEARTBEAT_TIMEOUT_MS = 6 * 1000;   // 6 seconds — if no pong, consider connection dead
